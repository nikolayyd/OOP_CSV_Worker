#ifndef FACULTY_NUMBER_COLUMN_H
#define FACULTY_NUMBER_COLUMN_H

#include "BaseColumn.h"

// class for Faculty number columns
class FNumberColumn : public BaseColumn {
private:
    vector<string> facultyNumberValues;
public:
    FNumberColumn();
    ~FNumberColumn() = default;
